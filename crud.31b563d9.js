...
function getStudents() {
    fetch(`${API_URL}/students`).then((response)=>response.json()).then((data)=>renderStudents(data)).catch((error)=>console.error(error));
}
function renderStudents(students) {
    ...
    students.forEach((student)=>{
        ...
        tr.innerHTML = `
                ...
                <td>
                    <button onclick="updateStudent('${student.id}')" style="background-color: orange;">\u{41E}\u{43D}\u{43E}\u{432}\u{438}\u{442}\u{438}</button>
...
},{}]},["5j6Kf","a0t4e"], "a0t4e", "parcelRequirea17c", {})

//# sourceMappingURL=crud.31b563d9.js.map
